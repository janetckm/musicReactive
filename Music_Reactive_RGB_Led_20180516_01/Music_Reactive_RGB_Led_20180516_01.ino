...
//Confirmed microphone low value, and max value；original MIC_HIGH 737.0
#define MIC_LOW 0.0
#define MIC_HIGH 100.0
/** Other macros */
//How many previous sensor values effects the operating average?;ORI:15
#define AVGLEN 10
//How many previous sensor values decides if we are on a peak/HIGH (e.g. in a song);ORI:5
...
//How long do we keep the "current average" sound, before restarting the measuring;ORI:2000
#define MSECS 1000
